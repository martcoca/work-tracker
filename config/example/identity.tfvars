# Synthetic values for an offline, refresh-disabled plan only. The Founder supplies every
# real identifier and credential through protected plan/apply inputs.
