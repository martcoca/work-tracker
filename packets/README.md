...
| — | [`0004-E03-T05.md`](0004-E03-T05.md) | done | **Take this before E03-T01.** A credential names the workload it acts as, so there is something to look up in 0000's grant export (ADR-0057) |
| — | [`0004-E02-T06.md`](0004-E02-T06.md) | not started | **Take this first.** The credential routes have no human door, and E03-T01 needs a human to create the first credential (ADR-0056) |
| — | [`0004-E03-T06.md`](0004-E03-T06.md) | not started | Authoring is gated on a human verifier and the spec assigns it to the chief-of-staff. Needs 0000-E05-T06's scopes (ADR-0058) |
