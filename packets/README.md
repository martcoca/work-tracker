...
| — | [`0004-E02-T04.md`](0004-E02-T04.md) | not started | **Take this before E02-T03.** How an export actually reaches the reader: fetch at runtime, hold the last good copy, fail closed when it expires |
