...
| 9 | [`0004-E05-T04.md`](0004-E05-T04.md) | not started | **Rollback must reach a previous version.** E05-T02's mechanism cannot: each deploy reclaims the previous traffic tag, so the only reachable revision is the one already serving |
| 10 | [`0004-E05-T02.md`](0004-E05-T02.md) | in progress | Own `tracker.martcoca.com` in the plan rather than by hand, and make rollback one action |
